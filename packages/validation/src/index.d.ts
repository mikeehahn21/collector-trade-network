...
export declare const collectorTypeSchema: z.ZodEnum<
  ["collector", "seller", "seller_collector", "new_to_vintage"]
>;
export declare const shirtSizeSchema: z.ZodEnum<
  ["xs", "s", "m", "l", "xl", "xxl", "xxxl", "one_size", "measurements_matter"]
>;
export declare const vintageCategorySchema: z.ZodEnum<
  [
    "band",
    "rap",
    "harley",
...
>;
export declare const tradeOfferPreferenceSchema: z.ZodEnum<
  ["all_serious_offers", "wishlist_only", "restricted_categories"]
>;
export declare const communicationPreferenceSchema: z.ZodEnum<
...
>;
export declare const itemConditionSchema: z.ZodEnum<
  ["deadstock", "excellent", "very_good", "good", "fair", "project"]
>;
export declare const itemVisibilitySchema: z.ZodEnum<
  ["private", "approved_members", "verified_members"]
>;
...
>;
export declare const estimatedValueRangeSchema: z.ZodEffects<
  z.ZodObject<
    {
...
export declare const aiListingSuggestionsSchema: z.ZodObject<
  {
    ...
    >;
    size: z.ZodOptional<
      z.ZodEnum<["xs", "s", "m", "l", "xl", "xxl", "xxxl", "one_size", "measurements_matter"]>
    >;
    era: z.ZodOptional<z.ZodString>;
    condition: z.ZodOptional<
      z.ZodEnum<["deadstock", "excellent", "very_good", "good", "fair", "project"]>
    >;
    tag: z.ZodOptional<z.ZodString>;
    estimatedValue: z.ZodOptional<
      z.ZodEffects<
        z.ZodObject<
          {
            min: z.ZodOptional<z.ZodNumber>;
...
export declare const tradeableItemDraftSchema: z.ZodObject<
  {
    ...
    >;
    status: z.ZodDefault<
      z.ZodEnum<["draft", "tradeable", "pending_trade", "reserved", "traded", "archived"]>
    >;
    tradePreference: z.ZodOptional<
      z.ZodEnum<["all_serious_offers", "wishlist_only", "restricted_categories"]>
    >;
    tradeNotes: z.ZodOptional<z.ZodString>;
    visibility: z.ZodDefault<z.ZodEnum<["private", "approved_members", "verified_members"]>>;
    communicationPreference: z.ZodDefault<
      z.ZodEnum<
        ["approved_traders", "verified_only", "completed_trade_users", "matching_signal_users"]
      >
    >;
  ...
  },
  {
    tag?: string | undefined;
    status?:
      "draft" | "tradeable" | "pending_trade" | "reserved" | "traded" | "archived" | undefined;
    title?: string | undefined;
    category?:
      | "band"
      | "rap"
...
export declare const wishlistVisibilitySchema: z.ZodEnum<
  ["private", "approved_members", "verified_members"]
>;
export declare const wishlistItemDraftSchema: z.ZodObject<
  {
    ...
    preferredCondition: z.ZodOptional<
      z.ZodEnum<["deadstock", "excellent", "very_good", "good", "fair", "project"]>
    >;
  ...
  z.ZodTypeAny,
  {
    ...
    preferredCondition?:
      "deadstock" | "excellent" | "very_good" | "good" | "fair" | "project" | undefined;
...
export declare const onboardingPreferencesSchema: z.ZodObject<
  {
    ...
    wornSizes: z.ZodArray<
      z.ZodEnum<["xs", "s", "m", "l", "xl", "xxl", "xxxl", "one_size", "measurements_matter"]>,
      "many"
    >;
    collectedSizes: z.ZodArray<
      z.ZodEnum<["xs", "s", "m", "l", "xl", "xxl", "xxxl", "one_size", "measurements_matter"]>,
      "many"
    >;
    ...
    communicationPreference: z.ZodEnum<
      ["approved_traders", "verified_only", "completed_trade_users", "matching_signal_users"]
    >;

...
const collectorTypeOptions: Array<{
  description: string;
  label: string;
  value: CollectorType;
}> = [
...
const categoryOptions: VintageCategory[] = [
  "band",
  "rap",
  "harley",
  "sports",
...
const tradeOfferPreferenceOptions: Array<{
  description: string;
  label: string;
...
const onboardingSetupSteps: Array<{ id: OnboardingSetupStep; label: string }> = [
...
function SizesStep({ mode }: { mode: "collected" | "worn" }) {
...
function CommunicationPreferenceStep() {
...
function OnboardingStepHeader({ body, title }: { body: string; title: string }) {
  return (
...
function OnboardingProgressDots({ count, index }: { count: number; index: number }) {
  return (
    <View
      style={{
        alignItems: "center",
...
function isOnboardingStepReady(step: OnboardingSetupStep, state: { [key: string]: unknown }) {
...
function getCollectorTypeLabel(value: CollectorType): string {

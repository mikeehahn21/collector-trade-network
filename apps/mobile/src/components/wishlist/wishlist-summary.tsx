...
import type { WishlistSummary } from "@ctn/types";

import { useTheme } from "@/theme/theme-provider";

type WishlistSummaryPanelProps = {
  summary: WishlistSummary;
};

export function WishlistSummaryPanel({ summary }: WishlistSummaryPanelProps) {
  const theme = useTheme();
  const stats = [
    { label: "Wants", value: summary.activeItems },
